...
public class DataGeneration
{
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeClient(), new Languages(generator, "en_us", Languages.MissingEntriesPolicy.EXCEPTION));
        generator.addProvider(event.includeClient(), new Languages(generator, "uk_ua", Languages.MissingEntriesPolicy.EXCEPTION));
    }
}